...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*btgutil.Block, error) {
	...
	blocks := make([]*btgutil.Block, 0, 256)
	genesis := btgutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
