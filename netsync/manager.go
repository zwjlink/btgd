...
import (
	...
	peerpkg "github.com/zwjlink/btgd/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*btgutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *btgutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *btgutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *btgutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
