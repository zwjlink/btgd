...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr btgutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*btgutil.Tx, error) {
...
func CreateBlock(prevBlock *btgutil.Block, inclusionTxs []*btgutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr btgutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*btgutil.Block, error) {
	...
	blockTxns := []*btgutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := btgutil.NewBlock(&block)
