...
func New(activeNet *chaincfg.Params, handlers *rpcclient.NotificationHandlers,
	...
	if handlers.OnFilteredBlockConnected != nil {
		...
		handlers.OnFilteredBlockConnected = func(height int32, header *wire.BlockHeader, filteredTxns []*btgutil.Tx) {
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// wallet.
	filterAddrs := []btgutil.Address{h.wallet.coinbaseAddr}
...
func (h *Harness) NewAddress() (btgutil.Address, error) {
...
//
// This function is safe for concurrent access.
func (h *Harness) ConfirmedBalance() btgutil.Amount {
...
func (h *Harness) CreateTransaction(targetOutputs []*wire.TxOut,
	feeRate btgutil.Amount) (*wire.MsgTx, error) {
...
//
// This function is safe for concurrent access.
func (h *Harness) GenerateAndSubmitBlock(txns []*btgutil.Tx, blockVersion int32,
	blockTime time.Time) (*btgutil.Block, error) {
...
func (h *Harness) GenerateAndSubmitBlockWithCustomCoinbaseOutputs(
	txns []*btgutil.Tx, blockVersion int32, blockTime time.Time,
	mineTo []wire.TxOut) (*btgutil.Block, error) {
	...
	prevBlock := btgutil.NewBlock(mBlock)
