...
// txouts.
func dbFetchSpendJournalEntry(dbTx database.Tx, block *btgutil.Block, view *UtxoViewpoint) ([]spentTxOut, error) {
...
func (b *BlockChain) createChainState() error {
	...
	genesisBlock := btgutil.NewBlock(b.chainParams.GenesisBlock)
...
func (b *BlockChain) initChainState() error {
	...
	err := b.db.View(func(dbTx database.Tx) error {
		...
		blockWeight := uint64(GetBlockWeight(btgutil.NewBlock(&block)))
...
// raw block for the provided node, deserialize it, and return a btgutil.Block
// with the height set.
func dbFetchBlockByNode(dbTx database.Tx, node *blockNode) (*btgutil.Block, error) {
...
func (b *BlockChain) BlockByHeight(blockHeight int32) (*btgutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*btgutil.Block, error) {
